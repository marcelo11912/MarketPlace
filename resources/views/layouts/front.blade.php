...
<body class="home">
    <div class="page-wrapper">
        <h1 class="d-none">Marketplace Deep Web</h1>
        <!-- Start of Header -->
        <header class="header">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="demo1.html" class="logo-footer">
                                    <img src="{{asset('assets\images\logo_footer.png')}}" alt="logo-footer" width="144" height="45">
                                </a>
                        ...
                        <div class="swiper-wrapper row cols-1 gutter-no">
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('assets\images\products\popup\1-440x494.jpg')}}" data-zoom-image="assets/images/products/popup/1-800x900.jpg')}}" alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('assets\images\products\popup\2-440x494.jpg')}}" data-zoom-image="assets/images/products/popup/2-800x900.jpg')}}" alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('assets\images\products\popup\3-440x494.jpg')}}" data-zoom-image="assets/images/products/popup/3-800x900.jpg')}}" alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('assets\images\products\popup\4-440x494.jpg')}}" data-zoom-image="assets/images/products/popup/4-800x900.jpg')}}" alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="product-thumbs-wrap swiper-container" data-swiper-options="{
                        ...
                        <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('assets\images\products\popup\1-103x116.jpg')}}" alt="Product Thumb" width="103" height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('assets\images\products\popup\2-103x116.jpg')}}" alt="Product Thumb" width="103" height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('assets\images\products\popup\3-103x116.jpg')}}" alt="Product Thumb" width="103" height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('assets\images\products\popup\4-103x116.jpg')}}" alt="Product Thumb" width="103" height="116">
                            </div>
                        </div>
                        <button class="swiper-button-next"></button>
                        <button class="swiper-button-prev"></button>
